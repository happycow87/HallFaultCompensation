...
//  GPIO-14 - PIN FUNCTION = TZ-FAULTn
	GpioCtrlRegs.GPAMUX1.bit.GPIO14 = 1;	// 0=GPIO,  1=TZ3,  2=SCITXDB,  3=SPICLKB
...
//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------
//  GPIO-16 - PIN FUNCTION = DACO_SPI-SIM
...
//--------------------------------------------------------------------------------------
//  GPIO-18 - PIN FUNCTION = DAC_SPI-CLK
...
//--------------------------------------------------------------------------------------
//  GPIO-19 - PIN FUNCTION = DAC_SPI-STE
...
//--------------------------------------------------------------------------------------
//  GPIO-27 - PIN FUNCTION = /SCS
	GpioCtrlRegs.GPAMUX2.bit.GPIO27 = 3;	// 0=GPIO,  1=HRCAP2,  2=EQEP2S,  3=SPISTEB
...
//--------------------------------------------------------------------------------------
//  GPIO-41 - PIN FUNCTION = CAP2
	GpioCtrlRegs.GPBMUX1.bit.GPIO41 = 0;	// 0=GPIO,  1=EPWM7B,  2=SCIRXDB,  3=Resv
	GpioCtrlRegs.GPBDIR.bit.GPIO41 = 0;		// 1=OUTput,  0=INput
//	GpioCtrlRegs.GPBPUD.bit.GPIO41 = 0;     // 0=enable pullup, disable pullup
