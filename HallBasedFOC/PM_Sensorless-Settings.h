...
#define LEVEL7  7           // fault detection
#define LEVEL8  8           // fault detection
#define LEVEL9  9           // hallBased simplified
#define LEVEL10  10         // fault detection based on hall sensor(final one)
#define LEVEL11  11         // fault detection based on hall sensor & EMF based FOC
						
/*------------------------------------------------------------------------------
This line sets the BUILDLEVEL to one of the available choices.
------------------------------------------------------------------------------*/
#define   BUILDLEVEL LEVEL11
...
#define RS      0.023//1.5//0.135
#define LS      0.000113//0.0021//0.000121564
...
#define POLES   46		    //8			// Number of poles

// Define the base quantites 
#define BASE_VOLTAGE    14.43		    // Base peak phase voltage (volt), maximum measurable DC Bus(66.32V)/sqrt(3)
#define PVDD            48.
#define DCBUSV          6
...
//#define BASE_CURRENT    15           // Base peak phase current (amp) , maximum measurable peak current (with DRV830x gain set to 20)
#elif DRV_GAIN == 40
...
#define BASE_FREQ      	280   //266.67				// Base electrical frequency (Hz)

#define PARAMETER_ESTIMATE 1
