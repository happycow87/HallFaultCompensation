...
#define HALL3_INIT_MACRO(v)																	\
	...
	/* Configure ECAP1/2/3 as GPIO-inputs (GPIO40/41/42) for Piccolo B*/					\
	GpioCtrlRegs.GPBMUX1.bit.GPIO40 = 0;  /* GPIO40 is HALL - A */							\
	GpioCtrlRegs.GPBMUX1.bit.GPIO41 = 0;  /* GPIO41 is HALL - B */							\
	GpioCtrlRegs.GPBMUX1.bit.GPIO42 = 0;  /* GPIO42 is HALL - C */							\
																							\
	/* Configure GPIO40/41/42 as inputs*/													\
	GpioCtrlRegs.GPBDIR.bit.GPIO40 = 0;   /* GPIO40 is HALL - A */							\
	GpioCtrlRegs.GPBDIR.bit.GPIO41 = 0;   /* GPIO41 is HALL - B */							\
	GpioCtrlRegs.GPBDIR.bit.GPIO42 = 0;   /* GPIO42 is HALL - C */							\
	EDIS;                         /* Disable EALLOW*/										\
																							\
...
#define HALL3_DETERMINE_STATE_MACRO(v)														\
	...
	temp = (GpioDataRegs.GPBDAT.all>>8)&0x00000007; /* read all three GPIOs at once*/		\
																							\
	v.HallBitA = (temp&0x00000001);			/* save GPIO40 - A*/						\
	v.HallBitB = (temp&0x00000002)>>1;		/* save GPIO41 - B*/						\
	v.HallBitC = (temp&0x00000004)>>2;		/* save GPIO42 - C*/						\
